                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                %>
                                    <tr>
                                        <td><%=x.getId_turma() %></td>
                                        <td><%=x.getNomeProfessor() %></td>
                                        <td><%=x.getTituloCurso() %></td>
                                        <td><%=x.getQant_horas() %></td>
                                        <td><%=x.getDt_inicio() %></td>
                                        <td><%=x.getDt_fim() %></td>
                                        <td align="center">
                                        ...
                                        <td><%=x.getCadastro() %></td>
                                        <td class="center">
                                        	<a href="controller.do?command=excluirTurma&id=<%=x.getId_turma()%>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td class="center">
                                        	<a href="frmAlterarTurma.jsp?id=<%=x.getId_turma()%>&ativo=<%=x.isAtivo()%>"
