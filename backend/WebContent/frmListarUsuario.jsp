<%@page import="com.eib.projetop1.beans.Usuario"%>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <% 
                                	Usuario u1 =  new Usuario();
 					               	Collection<Usuario> lista = u1.buscarTodos();
 					               	for(Usuario x : lista){
                                %>
                                    <tr>
                                        <td><%=x.getId_usuario() %></td>
                                        <td><%=x.getTituloPerfil()%></td>
                                        <td><%=x.getLogin() %></td>
                                        <td><%=x.getSenha() %></td>
                                        <td align="center">
                                        ...
                                        <td><%=x.getCadastro() %></td>
                                        <td align="center">
                                        	<a href="controller.do?command=excluirUsuario&id=<%=x.getId_usuario()%>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td align="center">
                                        	<a href="frmAlterarUsuario.jsp?id=<%=x.getId_usuario()%>&ativo=<%=x.isAtivo() %>"
