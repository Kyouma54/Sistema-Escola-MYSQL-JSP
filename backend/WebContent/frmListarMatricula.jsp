<%@page import="com.eib.projetop1.beans.Matricula"%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <% 
                                	Matricula c1 =  new Matricula();
 					               	Collection<Matricula> lista = c1.buscarTodos();
 					               	for(Matricula x : lista){
                                %>
                                    <tr>
                                        <td><%=x.getNomeCliente() %></td>
                                        <td><%=x.getId_turma() %></td>
                                        <td align="center">
                                        	<label style="display:none;visibility:hidden;" >
													<%=x.getAtivo() ? "#A":"#I"%>
											</label>
	                                        <button type="button" class="btn btn-<%=x.getAtivo() == true ? "success" : "danger"%> btn-xs">
	                                        	&nbsp;
	                                        	&nbsp;
	                                        </button>
                                        </td>
                                        <td><%=x.getCadastro() %></td>
                                        <td align="center">
                                        	<a href="controller.do?command=excluirMatricula&id=<%=x.getId_cliente()%>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td align="center">
                                        	<a href="frmAlterarMatricula.jsp?id=<%=x.getId_cliente()%>&ativo=<%=x.getAtivo() %>"
