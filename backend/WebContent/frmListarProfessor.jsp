                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4><b>Lista de Professores</b></h4>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td align="center">
	                                        ...
	                                        <button type="button" class="btn btn-<%=x.isAtivo() == true ? "success" : "danger"%> btn-xs">
	                                        	&nbsp;
	                                        	&nbsp;
	                                        </button>
                                        </td>
                                        <td><%=x.getCadastro() %></td>
                                        <td align="center">
                                        	<a href="controller.do?command=excluirProfessor&id=<%=x.getId_professor() %>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td align="center">
                                        	<a href="frmAlterarProfessor.jsp?id=<%=x.getId_professor()%>&ativo=<%=x.isAtivo()%>"
