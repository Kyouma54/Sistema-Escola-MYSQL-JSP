...
<%@page import="com.eib.projetop1.beans.Perfil"%>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" action="controller.do?command=alterarUsuario" method="post">
                                		...
                                		<input type="hidden" name="id" id="id" value="${param.id}" class="form-control" readonly required>
										  <div class="form-row">
										    ...
										    <div class="form-group col-md-6">
										      ...
										      <select class="form-control" id="perfil" name="idPerfil" required >
										      	<option value="">Selecione um perfil</option>
										      	<% 
										      		Perfil p1 = new Perfil();
										    		Collection<Perfil> lista = p1.buscarTodos();
										    		
										    		  for(Perfil x : lista){
										      	%>
										   
										      	<option value=<%=x.getIdPerfil()%>><%=x.getTitulo()%></option>
										      	<% 
										    		  }
										      	%>
										      </select>
