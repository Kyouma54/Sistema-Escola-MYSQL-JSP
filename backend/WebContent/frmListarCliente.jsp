                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <% 
                                	Cliente c1 =  new Cliente();
 					               	Collection<Cliente> lista = c1.buscarTodos();
 					               	for(Cliente x : lista){
                                %>
                                    <tr>
                                        ...
                                        <td><%=x.getCadastro() %></td>
                                        <td class="center">
                                        	<a href="controller.do?command=excluirCliente&id=<%=x.getId_cliente()%>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td class="center">
                                        	<a href="frmAlterarCliente.jsp?id=<%=x.getId_cliente()%>&ativo=<%=x.isAtivo() %>"
