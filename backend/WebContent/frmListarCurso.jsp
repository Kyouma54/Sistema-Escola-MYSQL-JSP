                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <% 
                                	Curso c1 =  new Curso();
 					               	Collection<Curso> lista = c1.buscarTodos();
 					               	for(Curso x : lista){
                                %>
                                    <tr>
                                        <td><%=x.getId_curso() %></td>
                                        ...
                                        <td><%=x.getCadastro() %></td>
                                        <td align="center">
                                        	<a href="controller.do?command=excluirCurso&id=<%=x.getId_curso()%>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td align="center">
                                        	<a href="frmAlterarCurso.jsp?id=<%=x.getId_curso()%>&ativo=<%=x.isAtivo()%>"
