                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                <% 
                                	Perfil c1 =  new Perfil();
 					               	Collection<Perfil> lista = c1.buscarTodos();
 					               	for(Perfil x : lista){
                                %>
                                    <tr>
                                        <td><%=x.getIdPerfil() %></td>
                                        ...
                                        <td><%=x.getCadastro() %></td>
                                        <td align="center">
                                        	<a href="controller.do?command=excluirPerfil&id=<%=x.getIdPerfil()%>"
                                        		class="btn btn-danger btn-xs">EXCLUIR</a>
                                        </td>
                                        <td align="center">
                                        	<a href="frmAlterarPerfil.jsp?id=<%=x.getIdPerfil()%>&ativo=<%=x.isAtivo() %>"
