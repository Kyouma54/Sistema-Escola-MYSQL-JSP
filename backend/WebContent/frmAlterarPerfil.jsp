                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Informações do Perfil</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="controller.do?command=alterarPerfil" method="post">
                                <fieldset class="col-lg-8">
                                			<input type="hidden" class="form-control" name= "id" id="id" value="${param.id}" readonly required>
                                			
										    <div class="form-group col-md-12">
										      <label for="titulo">Titulo</label>
										      <input type="text" class="form-control" name= "titulo" id="titulo" placeholder="Titulo" autofocus required>
										    </div>
