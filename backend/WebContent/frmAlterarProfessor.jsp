                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Informações do Professor</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="controller.do?command=alterarProfessor" method="post">
                                <fieldset class="col-lg-8">
										    ...
										    <div class="form-group col-md-12">
										      ...
										      <input type="text" class="form-control" name= "nome" id="nome" placeholder="Nome" autofocus required>
										    </div>
										    <div class="form-group col-md-12">
